...
#population mean
?filter
USA<-filter (Hemoglobin, population=="USA"); summary (USA)
...
pwr.p.test(h=h1,n=71,sig.level=0.05,alternative="two.sided")
#Ethiopia
...
ggplot (CI95, aes(x=population, y=mean.hemo, color=population)) + geom_point() + 
  ylim(15,20) + geom_errorbar(aes(ymin=lower.95, ymax=upper.95), width=0.1)
