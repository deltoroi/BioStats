...
#Chunk 4: Generate a Random Normal Distribution
	1) Create an object called “extra” of a normal distribution with a 20 observations a 
...
5.6 Use `shapiro.test` to test for normality in this distribution? What do the results suggest? Are the 
